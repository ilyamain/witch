...
if (!empty($_POST['message'])) 
{
	...
	?>
	<div id="transaction-form" class="bco-form" bill_number="<?=$bill_number;?>">
		<h2>Транзакция смены пароля банкноты</h2>
		...
		<form class="bill-actions">
			<div class="form-field command-field"><input type="hidden" name="command" value="bco"></div>
			<div class="form-row bill-output-item">
				<div class="form-field input-field requires">
					<input class="icon-sign" name="key" type="text" title="Новый пароль" placeholder="Новый пароль" value="<?=(new cWallet)->key_generate();?>">
